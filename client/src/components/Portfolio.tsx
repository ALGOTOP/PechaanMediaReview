...
const projects: Project[] = [
  {
    title: "WHIPPED",
    category: "Branding",
    description: "Beauty brand identity, logo design, and creative direction for premium-casual beauty brand",
    image: luminaImage,
  ...
  },
  {
    title: "SPHINX",
    category: "Web",
    description: "Website redesign and engineering company web development for a service management eco-system",
    image: sphinxImage,
  ...
  },
  {
    title: "KENETIK",
    category: "Film",
    description: "3D motion ads and brand identity content for KENETIK energy drink branding — filmed in IRL and created in 3D",
  ...
  },
  {
    title: "HALVA",
    category: "Branding",
    description: "Food packaging design and brand identity — bold flavour cues with clean, shelf-ready visual identity",
    image: halvaImage,
    aspectRatio: "square",
  },
  {
  ...
  },
  {
    title: "TRULY",
    category: "Film",
    description: "4D graphic post production and advertising campaign for cinematic brand storytelling",
    image: trulyImage,
    aspectRatio: "portrait",
  },
];
